...
```{r echo=FALSE,out.width="100%", fig.align='center', fig.cap="Bands of created image"}
...
```{r echo=FALSE, out.width="100%", fig.align='center', fig.cap="the NDVI index for Pearl River Delta."}
...
```{r echo=FALSE, out.width="100%", fig.align='center', fig.cap="Texture "}
