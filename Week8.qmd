...
I load up a level 2 administrative area to extract termperature data for Hong Kong in summer months from May to September. As mentioned in the practical, the data comes with Kelvin (K), converting it back to celcius (C), the formula is
...
I think urban heat island is a topic that has be brought up for years,
