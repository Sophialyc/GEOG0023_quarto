...
To classify Antwerpen with s supervised model, the training dataset has to be selected
...
Classification of image in remote sensing is much more complicated than I think. I originally think image classification is just a simple process by identifying different colour in the image, but in fact, it involves a lot of different technical and mathematical
